	...
	public static void main(String[] args) {
		...
		if(choice == 1)
		{
			...
			if(n == 2)
			{
				...
				System.out.println("2개의 정수의 평균은 " + average);
			}
			else if (n == 3)
			{
				...
				System.out.println("3개의 정수의 평균은 " + average);
			}
		}
		else if (choice == 2)
		{
			...
			if(n == 2)
			{
				...
				System.out.println("2개의 실수의 평균은 " + average);
			}
			else if (n == 3)
			{
				...
				System.out.println("3개의 실수의 평균은 " + average);
			}
		}
		sc.close();
	}
